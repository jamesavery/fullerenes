...
c      abc_x=-bc_y*az + ac_y*bz - ab_y*cz
      abc_x=-ab_y*bc_z + ab_z*bc_y
c      abc_y=bc_x*az - ac_x*bz + ab_x*cz
      abc_y=-ab_z*bc_x + ab_x*bc_z
c      abc_z=-bc_x*ay + ac_x*by - ab_x*cy
      abc_z=-ab_x*bc_y + ab_y*bc_x
c      bcd_x=-cd_y*bz + bd_y*cz - bc_y*dz
      bcd_x=-bc_y*cd_z + bc_z*cd_y
c      bcd_y=cd_x*bz - bd_x*cz + bc_x*dz
      bcd_y=-bc_z*cd_x + bc_x*cd_z
c      bcd_z=cd_y*bx - bd_y*cx + bc_y*dx
...
c the result
      ...
      SUBROUTINE XDDIHEDRAL(ax,ay,az,bx,by,bz,cx,cy,cz,dx,dy,dz,
...
c
      ...
      write(*,*)'lcl3,x,y,z',bc_length_inv_cub,dbc_length_inv__dbc_x,
     2  dbc_length_inv__dbc_y,dbc_length_inv__dbc_z
...
c abc_x=-ab_y*bc_z + ab_z*bc_y
      dabc_x__dax=0
c dabc_x__dab_y*dab_y__dax + dabc_x__dbc_z*dbc_z__dax
c     2          + dabc_x__dab_z*dab_z__dax + dabc_x__dbc_y*dbc_y__dax
      dabc_x__day=dabc_x__dab_y*dab_y__day
c + dabc_x__dbc_z*dbc_z__day
c     2          + dabc_x__dab_z*dab_z__day + dabc_x__dbc_y*dbc_y__day
      dabc_x__daz=
cdabc_x__dab_y*dab_y__daz + dabc_x__dbc_z*dbc_z__daz +
     2           dabc_x__dab_z*dab_z__daz
c + dabc_x__dbc_y*dbc_y__daz
      dabc_x__dbx=0
c dabc_x__dab_y*dab_y__dbx + dabc_x__dbc_z*dbc_z__dbx
c     2          + dabc_x__dab_z*dab_z__dbx + dabc_x__dbc_y*dbc_y__dbx
      dabc_x__dby=dabc_x__dab_y*dab_y__dby +
c dabc_x__dbc_z*dbc_z__dby
c     2          + dabc_x__dab_z*dab_z__dby
     2  dabc_x__dbc_y*dbc_y__dby
      dabc_x__dbz=
c dabc_x__dab_y*dab_y__dbz + 
     2 dabc_x__dbc_z*dbc_z__dbz
     2          + dabc_x__dab_z*dab_z__dbz
c + dabc_x__dbc_y*dbc_y__dbz
      dabc_x__dcx=0
c dabc_x__dab_y*dab_y__dcx + dabc_x__dbc_z*dbc_z__dcx
c     2          + dabc_x__dab_z*dab_z__dcx + dabc_x__dbc_y*dbc_y__dcx
      dabc_x__dcy=dabc_x__dab_y*dab_y__dcy + dabc_x__dbc_z*dbc_z__dcy
     2          + dabc_x__dab_z*dab_z__dcy + dabc_x__dbc_y*dbc_y__dcy
      dabc_x__dcz=dabc_x__dab_y*dab_y__dcz + dabc_x__dbc_z*dbc_z__dcz
     2          + dabc_x__dab_z*dab_z__dcz + dabc_x__dbc_y*dbc_y__dcz
c abc_y=-ab_z*bc_x + ab_x*bc_z
      dabc_y__dax=dabc_y__dab_z*dab_z__dax + dabc_y__dbc_x*dbc_x__dax
     2          + dabc_y__dab_x*dab_x__dax + dabc_y__dbc_z*dbc_z__dax
      dabc_y__day=dabc_y__dab_z*dab_z__day + dabc_y__dbc_x*dbc_x__day
     2          + dabc_y__dab_x*dab_x__day + dabc_y__dbc_z*dbc_z__day
      dabc_y__daz=dabc_y__dab_z*dab_z__daz + dabc_y__dbc_x*dbc_x__daz
     2          + dabc_y__dab_x*dab_x__daz + dabc_y__dbc_z*dbc_z__daz
      dabc_y__dbx=dabc_y__dab_z*dab_z__dbx + dabc_y__dbc_x*dbc_x__dbx
     2          + dabc_y__dab_x*dab_x__dbx + dabc_y__dbc_z*dbc_z__dbx
      dabc_y__dby=dabc_y__dab_z*dab_z__dby + dabc_y__dbc_x*dbc_x__dby
     2          + dabc_y__dab_x*dab_x__dby + dabc_y__dbc_z*dbc_z__dby
      dabc_y__dbz=dabc_y__dab_z*dab_z__dbz + dabc_y__dbc_x*dbc_x__dbz
     2          + dabc_y__dab_x*dab_x__dbz + dabc_y__dbc_z*dbc_z__dbz
      dabc_y__dcx=dabc_y__dab_z*dab_z__dcx + dabc_y__dbc_x*dbc_x__dcx
     2          + dabc_y__dab_x*dab_x__dcx + dabc_y__dbc_z*dbc_z__dcx
      dabc_y__dcy=dabc_y__dab_z*dab_z__dcy + dabc_y__dbc_x*dbc_x__dcy
     2          + dabc_y__dab_x*dab_x__dcy + dabc_y__dbc_z*dbc_z__dcy
      dabc_y__dcz=dabc_y__dab_z*dab_z__dcz + dabc_y__dbc_x*dbc_x__dcz
     2          + dabc_y__dab_x*dab_x__dcz + dabc_y__dbc_z*dbc_z__dcz
c abc_z=-ab_x*bc_y + ab_y*bc_x
      dabc_z__dax=dabc_z__dab_x*dab_x__dax + dabc_z__dbc_y*dbc_y__dax
     2          + dabc_z__dab_y*dab_y__dax + dabc_z__dbc_x*dbc_x__dax
      dabc_z__day=dabc_z__dab_x*dab_x__day + dabc_z__dbc_y*dbc_y__day
     2          + dabc_z__dab_y*dab_y__day + dabc_z__dbc_x*dbc_x__day
      dabc_z__daz=dabc_z__dab_x*dab_x__daz + dabc_z__dbc_y*dbc_y__daz
     2          + dabc_z__dab_y*dab_y__daz + dabc_z__dbc_x*dbc_x__daz
      dabc_z__dbx=dabc_z__dab_x*dab_x__dbx + dabc_z__dbc_y*dbc_y__dbx
     2          + dabc_z__dab_y*dab_y__dbx + dabc_z__dbc_x*dbc_x__dbx
      dabc_z__dby=dabc_z__dab_x*dab_x__dby + dabc_z__dbc_y*dbc_y__dby
     2          + dabc_z__dab_y*dab_y__dby + dabc_z__dbc_x*dbc_x__dby
      dabc_z__dbz=dabc_z__dab_x*dab_x__dbz + dabc_z__dbc_y*dbc_y__dbz
     2          + dabc_z__dab_y*dab_y__dbz + dabc_z__dbc_x*dbc_x__dbz
      dabc_z__dcx=dabc_z__dab_x*dab_x__dcx + dabc_z__dbc_y*dbc_y__dcx
     2          + dabc_z__dab_y*dab_y__dcx + dabc_z__dbc_x*dbc_x__dcx
      dabc_z__dcy=dabc_z__dab_x*dab_x__dcy + dabc_z__dbc_y*dbc_y__dcy
     2          + dabc_z__dab_y*dab_y__dcy + dabc_z__dbc_x*dbc_x__dcy
      dabc_z__dcz=dabc_z__dab_x*dab_x__dcz + dabc_z__dbc_y*dbc_y__dcz
     2          + dabc_z__dab_y*dab_y__dcz + dabc_z__dbc_x*dbc_x__dcz
c bcd_x=-bc_y*cd_z + bc_z*cd_y
      dbcd_x__dbx=dbcd_x__dbc_y*dbc_y__dbx + dbcd_x__dcd_z*dcd_z__dbx
     2          + dbcd_x__dbc_z*dbc_z__dbx + dbcd_x__dcd_y*dcd_y__dbx
      dbcd_x__dby=dbcd_x__dbc_y*dbc_y__dby + dbcd_x__dcd_z*dcd_z__dby
     2          + dbcd_x__dbc_z*dbc_z__dby + dbcd_x__dcd_y*dcd_y__dby
      dbcd_x__dbz=dbcd_x__dbc_y*dbc_y__dbz + dbcd_x__dcd_z*dcd_z__dbz
     2          + dbcd_x__dbc_z*dbc_z__dbz + dbcd_x__dcd_y*dcd_y__dbz
      dbcd_x__dcx=dbcd_x__dbc_y*dbc_y__dcx + dbcd_x__dcd_z*dcd_z__dcx
     2          + dbcd_x__dbc_z*dbc_z__dcx + dbcd_x__dcd_y*dcd_y__dcx
      dbcd_x__dcy=dbcd_x__dbc_y*dbc_y__dcy + dbcd_x__dcd_z*dcd_z__dcy
     2          + dbcd_x__dbc_z*dbc_z__dcy + dbcd_x__dcd_y*dcd_y__dcy
      dbcd_x__dcz=dbcd_x__dbc_y*dbc_y__dcz + dbcd_x__dcd_z*dcd_z__dcz
     2          + dbcd_x__dbc_z*dbc_z__dcz + dbcd_x__dcd_y*dcd_y__dcz
      dbcd_x__ddx=dbcd_x__dbc_y*dbc_y__ddx + dbcd_x__dcd_z*dcd_z__ddx
     2          + dbcd_x__dbc_z*dbc_z__ddx + dbcd_x__dcd_y*dcd_y__ddx
      dbcd_x__ddy=dbcd_x__dbc_y*dbc_y__ddy + dbcd_x__dcd_z*dcd_z__ddy
     2          + dbcd_x__dbc_z*dbc_z__ddy + dbcd_x__dcd_y*dcd_y__ddy
      dbcd_x__ddz=dbcd_x__dbc_y*dbc_y__ddz + dbcd_x__dcd_z*dcd_z__ddz
     2          + dbcd_x__dbc_z*dbc_z__ddz + dbcd_x__dcd_y*dcd_y__ddz
c bcd_y=-bc_z*cd_x + bc_x*cd_z
      dbcd_y__dbx=dbcd_y__dbc_z*dbc_z__dbx + dbcd_y__dcd_x*dcd_x__dbx
     2          + dbcd_y__dbc_x*dbc_x__dbx + dbcd_y__dcd_z*dcd_z__dbx
      dbcd_y__dby=dbcd_y__dbc_z*dbc_z__dby + dbcd_y__dcd_x*dcd_x__dby
     2          + dbcd_y__dbc_x*dbc_x__dby + dbcd_y__dcd_z*dcd_z__dby
      dbcd_y__dbz=dbcd_y__dbc_z*dbc_z__dbz + dbcd_y__dcd_x*dcd_x__dbz
     2          + dbcd_y__dbc_x*dbc_x__dbz + dbcd_y__dcd_z*dcd_z__dbz
      dbcd_y__dcx=dbcd_y__dbc_z*dbc_z__dcx + dbcd_y__dcd_x*dcd_x__dcx
     2          + dbcd_y__dbc_x*dbc_x__dcx + dbcd_y__dcd_z*dcd_z__dcx
      dbcd_y__dcy=dbcd_y__dbc_z*dbc_z__dcy + dbcd_y__dcd_x*dcd_x__dcy
     2          + dbcd_y__dbc_x*dbc_x__dcy + dbcd_y__dcd_z*dcd_z__dcy
      dbcd_y__dcz=dbcd_y__dbc_z*dbc_z__dcz + dbcd_y__dcd_x*dcd_x__dcz
     2          + dbcd_y__dbc_x*dbc_x__dcz + dbcd_y__dcd_z*dcd_z__dcz
      dbcd_y__ddx=dbcd_y__dbc_z*dbc_z__ddx + dbcd_y__dcd_x*dcd_x__ddx
     2          + dbcd_y__dbc_x*dbc_x__ddx + dbcd_y__dcd_z*dcd_z__ddx
      dbcd_y__ddy=dbcd_y__dbc_z*dbc_z__ddy + dbcd_y__dcd_x*dcd_x__ddy
     2          + dbcd_y__dbc_x*dbc_x__ddy + dbcd_y__dcd_z*dcd_z__ddy
      dbcd_y__ddz=dbcd_y__dbc_z*dbc_z__ddz + dbcd_y__dcd_x*dcd_x__ddz
     2          + dbcd_y__dbc_x*dbc_x__ddz + dbcd_y__dcd_z*dcd_z__ddz
c bcd_z=-bc_x*cd_y + bc_y*cd_x
      dbcd_z__dbx=dbcd_z__dbc_x*dbc_x__dbx + dbcd_z__dcd_y*dcd_y__dbx
     2          + dbcd_z__dbc_y*dbc_y__dbx + dbcd_z__dcd_x*dcd_x__dbx
      dbcd_z__dby=dbcd_z__dbc_x*dbc_x__dby + dbcd_z__dcd_y*dcd_y__dby
     2          + dbcd_z__dbc_y*dbc_y__dby + dbcd_z__dcd_x*dcd_x__dby
      dbcd_z__dbz=0
c dbcd_z__dbc_x*dbc_x__dbz + dbcd_z__dcd_y*dcd_y__dbz
c     2          + dbcd_z__dbc_y*dbc_y__dbz + dbcd_z__dcd_x*dcd_x__dbz
      dbcd_z__dcx=dbcd_z__dbc_x*dbc_x__dcx + dbcd_z__dcd_y*dcd_y__dcx
     2          + dbcd_z__dbc_y*dbc_y__dcx + dbcd_z__dcd_x*dcd_x__dcx
      dbcd_z__dcy=dbcd_z__dbc_x*dbc_x__dcy + dbcd_z__dcd_y*dcd_y__dcy
     2          + dbcd_z__dbc_y*dbc_y__dcy + dbcd_z__dcd_x*dcd_x__dcy
      dbcd_z__dcz=0
c dbcd_z__dbc_x*dbc_x__dcz + dbcd_z__dcd_y*dcd_y__dcz
c     2          + dbcd_z__dbc_y*dbc_y__dcz + dbcd_z__dcd_x*dcd_x__dcz
      dbcd_z__ddx=
c dbcd_z__dbc_x*dbc_x__ddx + dbcd_z__dcd_y*dcd_y__ddx
c     2          + dbcd_z__dbc_y*dbc_y__ddx +
     2 dbcd_z__dcd_x*dcd_x__ddx
      dbcd_z__ddy=dbcd_z__dbc_x*dbc_x__ddy + dbcd_z__dcd_y*dcd_y__ddy
     2          + dbcd_z__dbc_y*dbc_y__ddy + dbcd_z__dcd_x*dcd_x__ddy
      dbcd_z__ddz=0
c dbcd_z__dbc_x*dbc_x__ddz + dbcd_z__dcd_y*dcd_y__ddz
c     2          + dbcd_z__dbc_y*dbc_y__ddz + dbcd_z__dcd_x*dcd_x__ddz
...
c      dabc_length_inv__ddx=dabc_length_inv__dabc_x*dabc_x__ddx
c     3 + dabc_length_inv__dabc_y*dabc_y__ddx
c     4 + dabc_length_inv__dabc_z*dabc_z__ddx
c      dabc_length_inv__ddy=dabc_length_inv__dabc_x*dabc_x__ddy
c     3 + dabc_length_inv__dabc_y*dabc_y__ddy
c     4 + dabc_length_inv__dabc_z*dabc_z__ddy
c      dabc_length_inv__ddz=dabc_length_inv__dabc_x*dabc_x__ddz
c     3 + dabc_length_inv__dabc_y*dabc_y__ddz
c     4 + dabc_length_inv__dabc_z*dabc_z__ddz

c bcd_length_inv=1/dsqrt(bcd_x**2 + bcd_y**2 + bcd_z**2)
c derivatives according to dax, day, daz
c      dbcd_length_inv__dax=dbcd_length_inv__dbcd_x*dbcd_x__dax
c     3 + dbcd_length_inv__dbcd_y*dbcd_y__dax
c     4 + dbcd_length_inv__dbcd_z*dbcd_z__dax
c      dbcd_length_inv__day=dbcd_length_inv__dbcd_x*dbcd_x__day
c     3 + dbcd_length_inv__dbcd_y*dbcd_y__day
c     4 + dbcd_length_inv__dbcd_z*dbcd_z__day
c      dbcd_length_inv__daz=dbcd_length_inv__dbcd_x*dbcd_x__daz
c     3 + dbcd_length_inv__dbcd_y*dbcd_y__daz
c     4 + dbcd_length_inv__dbcd_z*dbcd_z__daz
...
c fortran (and most other sources) use '(y,x)' while mathematica uses '(x,y)'
      return
      END
