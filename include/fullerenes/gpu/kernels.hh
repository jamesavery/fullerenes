...
namespace gpu_kernels{
    namespace isomerspace_forcefield{
        ...
        template <ForcefieldType T> cudaError_t get_dihedral_rms    (const IsomerBatch& B, CuArray<device_real_t>& dihedral_rms);   //M x 1
        ...
        template <ForcefieldType T> cudaError_t get_bond_rms        (const IsomerBatch& B, CuArray<device_real_t>& bond_rms);       //M x 1
        ...
        template <ForcefieldType T> cudaError_t get_angle_rms       (const IsomerBatch& B, CuArray<device_real_t>& angle_rms);      //M x 1
        ...
        template <ForcefieldType T> cudaError_t get_flat_rms        (const IsomerBatch& B, CuArray<device_real_t>& flat_rms);      //M x 1
