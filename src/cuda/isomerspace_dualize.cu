...
void cubic_layout_(IsomerBatch B){
    ...
    device_node_t* smem = triangle_numbers + B.n_faces*6;
    //__shared__ device_node_t* triangle_numbers;
    //
    //if(threadIdx.x == 0) {
    //    triangle_numbers = (device_node_t*)malloc(B.n_faces*6*sizeof(device_node_t));
    //    memset(triangle_numbers, 0, sizeof(device_node_t)*B.n_faces*6);
    //}
    ...
    bool is_representative[6]; memset(is_representative,0,sizeof(device_node_t)*6);
