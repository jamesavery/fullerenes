...
int main(){
    ...
    **/
    ...
    IsomerspaceForcefield::OptimizeBatch(synth_X,synth_cubic_neighbours,synth_next_on_face,synth_prev_on_face,synth_face_right,N,batch_size);
}
