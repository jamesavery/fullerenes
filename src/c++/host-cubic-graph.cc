struct HostCubicGraph{
    ...
    HostCubicGraph(const device_node_t* cubic_neighbours) : cubic_neighbours(cubic_neighbours) {}
    ...
    */
    device_node_t dedge_ix(const device_node_t u, const device_node_t v) const{
    ...
    */
    device_node_t next(const device_node_t u, const device_node_t v) const{
    ...
    */
    device_node_t prev(const device_node_t u, const device_node_t v) const{
        device_node_t j = dedge_ix(u,v);
    ...
    */
    device_node_t next_on_face(const device_node_t u, const device_node_t v) const{
        return prev(v,u);
    }
    ...
    */
    device_node_t prev_on_face(const device_node_t u, const device_node_t v) const{
        return next(v,u);
    }
    ...
    */
    device_node_t face_size(device_node_t u, device_node_t v) const{
        device_node_t d = 1;
        device_node_t u0 = u;
        while (v != u0)
        {
    ...
    uint8_t get_face_oriented(device_node_t u, device_node_t v, device_node_t *f) const{
    ...
    device_node2 get_face_representation(device_node_t u, device_node_t v) const{
        constexpr int f_max =6;
        int i = 0;
        auto start_node = u;
