...
bool CubicGraphView::get_spiral_from_cg(const node_t f1, const node_t f2, const node_t f3, vector<int> &spiral, jumplist_t &jumps, const bool general) const
{
  spiral.clear();
  jumps.clear();
...
bool CubicGraphView::get_spiral_from_cg(vector<int> &spiral, jumplist_t &jumps, const bool canonical, const bool general, const bool pentagon_start) const
{
  spiral.clear();
  jumps.clear();
...
vector<int> CubicGraphView::vertex_numbers(const Triangulation &T, const vector<vector<node_t>> &permutations, const vector<node_t> &locants) const{
