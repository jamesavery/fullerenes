...
template <typename scalar> array<scalar,3> 
...
array<scalar,3>  eig_sort(scalar l1, scalar l2, scalar l3)
{
...
struct symMat3
{
 ...
 symMat3(device_real_t a, device_real_t b, device_real_t c, device_real_t d, device_real_t e, device_real_t f) : a(a), b(b), c(c), d(d), e(e), f(f){}
  
 device_coord3d eigenvalues() const{
    DEVICE_TYPEDEFS;
...
eigenvector3x3(device_real_t &lambda) const{
  ...
  pair<array<device_coord3d,3>,device_coord3d> 
