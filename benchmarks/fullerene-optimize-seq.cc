...
int main(int argc, char** argv){
    ...
    {   
        ...
        auto sample_size = min(100,(int)num_fullerenes.find(j)->second);
        ...
        for (int i = 0; i < sample_size; ++i){
            ...
            P.layout2d  = P.tutte_layout();
                auto T6 = high_resolution_clock::now(); Ttutte += T6-T5;
            P.points    = P.zero_order_geometry();
                auto T7 = high_resolution_clock::now(); TX0 += T7 - T6;
            P.optimize();
                auto T8 = high_resolution_clock::now(); Topt += T8 - T7;
        }
