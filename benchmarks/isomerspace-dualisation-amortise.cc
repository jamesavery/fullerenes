    ...
    {   
        ...
        auto finished_isomers = 0;
            ...
            for (size_t l = 0; l < N_runs + 1; l++){
                ...
                {
                case 0:
                    for (size_t i = 0; i < Ngpu; i++) isomerspace_dual::dualise(DBs[i], ctxs[i], LaunchPolicy::ASYNC);
                    break;
                case 1:
                    for (size_t i = 0; i < Ngpu; i++) isomerspace_dual::dualise_2(DBs[i], ctxs[i], LaunchPolicy::ASYNC);
                    break;
                case 2:
                    for (size_t i = 0; i < Ngpu; i++) isomerspace_dual::dualise_3(Q_test[i].host_batch);
                    break;
                case 3:
                    for (size_t i = 0; i < Ngpu; i++) isomerspace_dual::dualise_4(Q_test[i].host_batch);
                    break;
                default:
                    break;
                }
