...
int main(int argc, char** argv){
    ...
    {   
        ...
        for (size_t l = 0; l < N_runs; l++){
            ...
            IsomerBatch<GPU> batch1(N,M_b);
            device_io::IsomerQueue Q0(N);
            device_io::IsomerQueue Q1(N);
            device_io::IsomerQueue Q2(N);
            ...
            for (int i = 0; i < sample_size; ++i){
                for (size_t j = 0; j < Nf; j++){
                    ...
                    PlanarGraph pG = G.dual_graph();
                        auto T2 = high_resolution_clock::now(); T_seq[l] += (T2 - T0);
            ...
            while (Q2.get_size() < sample_size)
            {
                ...
                gpu_kernels::isomerspace_forcefield::optimize<PEDERSEN>(batch1,N*0.5,N*5);
