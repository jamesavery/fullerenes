...
int main(int argc, char** argv){
    ...
    ofstream rel_file("X0_validation_rel_" + to_string(N_start) + "_" + to_string(N_end) + ".txt");
    ofstream abs_file("X0_validation_abs_" + to_string(N_start) + "_" + to_string(N_end) + ".txt");

    ofstream rel_ex_file("X0_validation_ex_rel_" + to_string(N_start) + "_" + to_string(N_end) + ".txt");
    ofstream abs_ex_file("X0_validation_ex_abs_" + to_string(N_start) + "_" + to_string(N_end) + ".txt");
