...
int main(int ac, char **argv){
    ...
    auto CUBIC_TEST = [&](){
        ...
        isomerspace_dual::dualise(d_TestB, test_ctx, ASYNC);
        ...
        isomerspace_dual::dualise(d_ControlB, control_ctx, ASYNC);
    ...
    auto OPTIMIZE_TEST = [&](){
        ...
        TestQ2.refill_batch(d_TestB2, test_ctx, ASYNC);
        ControlQ2.refill_batch(d_ControlB2, control_ctx, ASYNC);
        isomerspace_forcefield::optimise<PEDERSEN>(d_TestB2, N, N*2,test_ctx, ASYNC);
        isomerspace_forcefield::optimise<PEDERSEN>(d_ControlB2, N, N*2,control_ctx, ASYNC);
        TestQ2.refill_batch(d_TestB2, test_ctx, ASYNC);
        ControlQ2.refill_batch(d_ControlB2, control_ctx, ASYNC);
        TestQ2.insert(d_TestB, test_ctx, ASYNC);
        ControlQ2.insert(d_ControlB, control_ctx, ASYNC);
    ...
    auto ORDERED_TEST = [&](){
        ...
        isomerspace_dual::dualise(d_TestB, test_ctx, SYNC);
        isomerspace_tutte::tutte_layout(d_TestB, 10000000, test_ctx, ASYNC);
        isomerspace_X0::zero_order_geometry(d_TestB, 4.0, test_ctx, ASYNC);
        ...
        isomerspace_forcefield::optimise<PEDERSEN>(d_TestB2, N*1, N*4,test_ctx, SYNC);
        TestQ2.refill_batch(d_TestB2, test_ctx, SYNC);
