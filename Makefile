...
CXXFLAGS= -g -O3 -std=c++11 -m64 -march=native -fPIC $(WARNINGS) $(DIRECTORIES) -DVERSION_NUMBER=$(VERSION_NUMBER)
#CXXFLAGS= -g3 -O3 -m64 -fPIC -Wall -Wno-sign-compare -std=c++11
FFLAGS= -g -O3 -m64 -Wall -fPIC -cpp -D'VERSION_NUMBER="$(VERSION_NUMBER)"'
