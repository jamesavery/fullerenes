...
The general Goldberg-Coxeter construction $GC_{k,l}[G_{0}]$ works in the following way: ($i$) consider
a cubic planar 
\marc{redundant?}
graph $G_{0}$ and take its dual (faces become vertices and
...
\marc{actually, the structures were not obtained by pymol ... (the picture are, though)}
