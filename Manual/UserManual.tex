...
from the canonical ring spiral pentagon indices (RSPI) through either a Tutte embedding (TE) or the adjacency matrix
eigenvector (AME) method. One can also construct the n-th leapfrog $GC_{1,1}^n$[C$_{n_v}$] fullerene or the halma fullerenes 
