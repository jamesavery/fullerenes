...
e.g. barrels instead of nanotubes. A more sophisticated force field using dihedral angles is also implemented (extended Wu force field),
...
\item[ScaleRad] Scaling paramater for Tutte sphere (Default: 4.0).
\end{description}
