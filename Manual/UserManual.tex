...
10) A restart option for subroutine Hamilton; 11) Use of ``House of Graphs'' fullerene database; 
12) Plotting program (other than latex) for producing Schlegel diagrams and corresponding duals
