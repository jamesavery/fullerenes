...
{\it List of options:}\\ 
{\bf NA, ICart, IV1, IV2, IV3, ixyz, filename, isonum, ichk, leap, IGCtrans, kGC, lGC, ISW, KE, IYF, ISW, ihueckel, ipsphere, loop, mirror, IP, IPRC, TolR, R5, R6}\\
...
{\bf ICart} = 0  needs to be specified. This is useful for reading for example cc1 files produced by M. Yoshida \cite{Yoshida}.\\
