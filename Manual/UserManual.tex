...
\paragraph{List of options:}\ 
 ...
 \paramname{ISchlegel, ISO1, ISO2, ISO3, IFS, ncycham, PS, Scale, ScalePPG, boost, ndual, labelvert} (Default: 0 for all values). We recommend \paramname{ISchlegel} = 1, 2, 4 or 7.
