...
It differs from the classical ring spiral algorithm in that it can insert jumps between the addition of two vertices to spiral in order
...
subgraph that hasn't been added to the spiral yet, must never be disconnected.  For deriving the graph from the spiral it is necessairy
...
The general Goldberg-Coxeter construction $GC_{k,l}[G_{0}]$ used here and shown in Figure \ref{pic:GoldbergCoxeter} works in the following way: ($i$) Consider
