...
showed how to construct the RSPIs,\cite{Rogers} which is implemented in this program as well for $GC_{k,l}(20)$. Figure \ref{pic:GK21C80} shows a $GC_{k,l}[\C{80}]$ transformation of a $D_{5d}$-\C{80} carbon nanotube transforming it into a chiral nanotube.

%Figure 2a
 \begin{figure}[htbp]
   	\centering
  	\includegraphics[width=0.6\textwidth]{GC(2,1)C80.png}
    \caption{Goldberg-Coxeter transformation $GC_{k,l}[\C{80}]$ transformation of a $D_{5d}$-\C{80} carbon nanotube into a chiral nanotube.}
	\label{pic:GK21C80}
 \end{figure}
