...
2-index insertions (subroutine {\bf EndoKrotoTrans}, Yoshida-Fowler 4-vertex (D3h 6555) and 6-vertex (D3h 666555) insertions 
(subroutine {\bf StoneWalesTrans})
...
-  Print all isomers and perform analysis introduced mostly in the book 
 ...
 For any questions concerning this program please contact P. Schwerdtfeger
   ...
   The time consuming steps in the program are ...
...
J. Cioslowski, N. Rao, D. Moncrieff, {\it Standard Enthalpies of Formation of Fullerenes and Their
Dependence on Structural Motifs}, J. Am. Chem. Soc. {\bf 122}, 8265Ð8270 (2000).\\\\
