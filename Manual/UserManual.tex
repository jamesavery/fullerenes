...
\end{description}
\item[ScaleRad] Scaling paramater for Tutte sphere.
...
\C{160} including the number of Hamiltonian cycles up to \C{100} for general and up to
\C{120} for IPR isomers. The database should be copied into
