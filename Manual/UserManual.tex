...
\begin{equation}
  \label{rho}
  \rho=\frac{W(G)}{n_v W_{min}} \quad \text{ with } \quad W_{min}= \text{min} \{ W_i \}  \quad \text{ and } \quad W_i=\sum_{j \in V(G)} d(i,j)
\end{equation}
and
\begin{equation}
  \label{rhoE}
  \rho_E=\frac{W_{max}}{W_{min}} \quad \text{ with } \quad W_{max}= \text{max} \{ W_i \}
\end{equation}
