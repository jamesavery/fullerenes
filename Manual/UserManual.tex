...
The main program (\filename{main.f}) calls a number of subroutines for certain tasks and in a certain sequence (see  \ref{pic:flow_long}).
...
Important steps in the program are given in the \ref{pic:flow_long} and are
explained in some detail in this section.   \ref{pic:flow_short} visualizes the workflow in a more abstract way.
