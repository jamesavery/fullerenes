...
In a next step all edges are determined by analyzing connectivities between vertices from either given cartesian
coordinates or from adjacency matrix if ring spiral as input is used (Subroutine {\bf Connect}). In any case
...
captured in this program, and one needs to perform a proper quantum theoretical calculation.
