...
optional coulomb force of the vanilla Wu field.
...
If \paramname{ICart} = 2 or 3 and \paramname{isonum} not zero, than pentagon indices are taken from the isomer list contained in a database (see below).
\item[{IPRC}]
