...
\item[jumps] An array of up to 10 jump positions $j_i$ and step lengths $l_i$, i.e. $(j_1,l_1,j_2,l_2,...)$.  
...
Note that $j_i$ denotes the face to jump to, and $l_i$ the number of moves ($l_i=1$ means no jump and is therefore obsolete).
