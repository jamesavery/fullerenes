...
A Fortran and C++ Program (Version 4.4)}, (Massey University Albany, 
...
4.4 introduced a search algorithm for neighborhood RSPIs, the Szeged index and pentagon arm indices as further topological descriptors.
Also the Tutte embedding algorithm has been made much faster and the fullerene database has been transformed into a more compact version.
