...
\begin{equation}
  \label{mean}
  \langle k^n \rangle = \frac{\sum_{k=1}^{6} k^n h_k}{\sum_{k=0}^{6} h_k}
\end{equation}
...
strongly isolated. The first leapfrog of \C{60}, \C{180}, is strongly isolated.
