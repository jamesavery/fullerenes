...
It produces the canonical ring spiral pentagon indices if the fullerene is spiral.
A general ring-spiral algorithm is currently in preparation.
...
If {\bf IFS} = 1: A tex file named {\bf texname} is produced which contains the 2D fullerene graph.\\
If {\bf IFS} = 2: A data file named {\bf graphname} is produced which contains all the information for producing a 2D fullerene graph with a plotting program.\\
