...
int main(int ac, char **argv){
    ...
    for(int N = N_begin; N < N_limit+1; N+=2){
        ...
        device_io::sort(h_validation);
        device_io::copy(d_validation, h_validation);
        isomerspace_forcefield::get_bond_rmse<PEDERSEN>(d_validation, bond_rms);
        isomerspace_forcefield::get_angle_rmse<PEDERSEN>(d_validation, angle_rms);
        isomerspace_forcefield::get_dihedral_rmse<PEDERSEN>(d_validation, dihedral_rms);
        isomerspace_forcefield::get_bond_max<PEDERSEN>(d_validation, bond_max);
        isomerspace_forcefield::get_angle_max<PEDERSEN>(d_validation, angle_max);
        isomerspace_forcefield::get_dihedral_max<PEDERSEN>(d_validation, dihedral_max);
        isomerspace_forcefield::get_energies<PEDERSEN>(d_validation, energies);
        isomerspace_forcefield::get_gradient_norm<PEDERSEN>(d_validation, gradient_norm);
        isomerspace_forcefield::get_gradient_rms<PEDERSEN>(d_validation, gradient_rms);
        isomerspace_forcefield::get_gradient_max<PEDERSEN>(d_validation, gradient_max);
